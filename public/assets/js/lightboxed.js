;( function ( $ , window , document , undefined ) {
	...
	$.extend( Lightboxed.prototype , {
		...
		addToCache : function ( element ) {
			...
			var dataLink = jQuery( element ).attr( 'data-link' );
			ext = dataLink.split('.').pop().toLowerCase();



			if ( ( ext || jQuery( element ).attr( 'href' ) || jQuery( element ).attr( 'data-src' ) || jQuery( element ).attr( 'src' ) ).match( 'jpg|gif|png|JPG|GIF|PNG|JPEG|jpeg|svg|SVG|tif|TIF|bmp|BMP' ) ) {
