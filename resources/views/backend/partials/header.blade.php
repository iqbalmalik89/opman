				...
				@if(!empty($settings->logo_img_path))
					...
					@php
						if(tenant())
							...
							$url = global_asset('site/' . $settings->logo_img_path);				
					@endphp

					<img alt="Logo" src="{{$url}}" class="h-30px" />
				@else
					{{$settings->site_title}}
				@endif
			...
			--}}
				...
				<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
					...
					<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
						<img src="{{global_asset('assets/media/avatars/blank.png')}}" alt="user" />
					</div>
						...
						<div class="menu-item px-3">
							<div class="menu-content d-flex align-items-center px-3">
								...
								<div class="symbol symbol-50px me-5">
									<img alt="Logo" src="{{global_asset('assets/media/avatars/blank.png')}}" />
								</div>
								<!--end::Avatar-->
								<!--begin::Username-->
								<div class="d-flex flex-column">
									<div class="fw-bold d-flex align-items-center fs-5">{{Auth::user()['first_name'].' '. Auth::user()['last_name']}}
									<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ucfirst(Auth::user()->getRoleNames()[0])}}</span></div>
