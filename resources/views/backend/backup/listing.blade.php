...
<!--         <button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
		...
		@if(Auth::user()->hasPermissionTo('add user'))
	        <a class="btn btn-primary create-btn" href="javascript:void(0);" onclick="createBackup();">
	        	<i class="fa-solid fa-spinner d-none fa-spin fs-3"></i>
	            Create {{App\Library\ModuleConfig::getModuleConfig($GLOBALS['module'])['module_name']}}
	        </a>
