	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Banned {{App\Library\ModuleConfig::getModuleConfig($GLOBALS['module'])['plural']}}</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
				<!--end::Breadcrumb-->
			</div>
...
<!--         <button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
    ...
    <!--end::Group actions-->
				...
				<div class="card-body py-4">
					...
					<table id="banned_listing" class="table align-middle table-row-dashed fs-6 gy-5">
					    <thead>
