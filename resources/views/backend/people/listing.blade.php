...
<input type="hidden" name="people_type" value="{{$type}}">
	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{ucfirst($type)}} {{App\Library\ModuleConfig::getModuleConfig($GLOBALS['module'])['plural']}} List</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
				<!--end::Breadcrumb-->
			</div>
