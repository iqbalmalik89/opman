	...
	<div id="kt_app_content" class="app-content flex-column-fluid">
		...
		<div id="kt_app_content_container" class="app-container container-xxl">
			...
			<div class="row gy-5 g-xl-10">
				<!--begin::Col-->
				@foreach($status_counts as $status => $statusCount)
					<div class="col-sm-6  col-xl-3 mb-xl-10">
						<!--begin::Card widget 2-->
						<div class="card h-lg-100 bg-{{$statusCount['class']}}">
							<!--begin::Body-->
							<div class="card-body d-flex justify-content-between align-items-start flex-column">
								...
								<div class="d-flex flex-column my-7">
									<!--begin::Number-->
									<span class="fw-semibold fs-3x text-white lh-1 ls-n2">{{$statusCount['count']}}</span>
									<!--end::Number-->
									<!--begin::Follower-->
									<div class="m-0">
										<span class="fw-semibold fs-6 text-white">{{ucfirst($status)}} Companies</span>
									</div>
									<!--end::Follower-->
								</div>
								<!--end::Section-->
