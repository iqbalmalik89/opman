...
<!--         <button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
		...
		@if(Auth::user()->hasPermissionTo('add subcontractor team'))
	        <a class="btn btn-primary" href="{{route('create-'.App\Library\ModuleConfig::getModuleConfig($GLOBALS['module'])['module'], $subcontractor_id)}}">
