...
<input type="hidden" name="subcontractor_id" id="subcontractor_id" value="{{$subcontractor_id ?? ''}}" />
...
<div class="mb-5 hover-scroll-x">
    <div class="d-grid">
        <ul class="nav nav-tabs flex-nowrap text-nowrap">
            <li class="nav-item">
                <a class="nav-link active btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0" data-bs-toggle="tab" href="#kt_tab_pane_1">Training ({{$active}})</a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0" data-bs-toggle="tab" href="#kt_tab_pane_2">Pending ({{$pending}})</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
		...
		<table id="training_pending_listing" class="table align-middle table-row-dashed fs-6 gy-5">
		    <thead>
		    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
		        <th>Operative</th>
		        <th>Competency</th>
