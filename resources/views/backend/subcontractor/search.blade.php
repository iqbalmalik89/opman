	...
	<div id="kt_app_toolbar" class="app-toolbar py- py-lg-2" >
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			<div style="margin-top:10px; margin-bottom: 10px;" class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<h1  class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Subcontractor Search</h1>
			</div>
									
			<div class="d-flex align-items-center gap-2 gap-lg-3">
				@if(Auth::user()->hasPermissionTo('add subcontractor'))
					<a href="{{route('create-subcontractor')}}" class="btn btn-sm fw-bold btn-primary">
						<span class="indicator-label">Add New Subcontractor</span>
					</a>
				@endif
			</div>
		</div>
	...
	<div id="kt_app_content" class="app-content flex-column-fluid">
		...
		<div id="kt_app_content_container" class="app-container container-xxl">
			...
			<div class="d-flex flex-column flex-lg-row">
					...
					<div class="card card-flush">
						...
						<div class="card-header pt-7" id="kt_chat_contacts_header">
							<form class="w-100 position-relative" autocomplete="off">
								...
								<input type="text" class="form-control form-control-solid px-15" name="site_search" id="subcontractor_search" onkeyup="searchSubcontractor();" value="" placeholder="Search Subcontractor" />
						...
						<div class="card-body pt-5" style="padding:10px" id="kt_chat_contacts_body">
							<!--begin::List-->
							<div class="scroll-y me-n5 pe-5 h-800px subcontractor-list" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_app_header, #kt_toolbar, #kt_app_toolbar, #kt_footer, #kt_app_footer, #kt_chat_contacts_header" data-kt-scroll-wrappers="#kt_content, #kt_app_content, #kt_chat_contacts_body" data-kt-scroll-offset="5px">
				...
				<div class="col-xl-8 flex-lg-row-fluid ms-lg-7 ms-xl-10" id="subcontractor-detail">
